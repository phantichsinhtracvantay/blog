...
$(document).ready(function() {
    ...
    $("#f_chat_source").html("<a target='_blank' href='https://www.facebook.com/phantichsinhtrachocdauvantay'><i class='fa fa-question-circle'></i> Live Chat Facebook</a><label>" + f_chat_vs + "</label>");
    setTimeout(function() {
        f_ck_chat()
    }, 100)
});
